          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {!isGameStarted ? (
              <div className="space-y-4 relative">
                <div className="text-xl text-[#C39A6B]">Press "1" for single player</div>
                <div className="text-lg text-zinc-400">Press "1" and "2" within 1 second for multiplayer</div>
                ...
                <div className="h-16 relative">
                  {isWaitingForKey2 && (
                    <div className="waiting-animation text-2xl text-[#D5001C] absolute top-0 left-0 right-0">
                      ...
                      <div className="text-lg text-white">Press "2" for multiplayer!</div>
              ...
              <div className="winner-announcement space-y-4 relative">
                ...
                <div className="text-xl text-[#C39A6B]">Press "1" to play again</div>
                <div className="text-lg text-zinc-400">Press "1" and "2" together for multiplayer</div>
              ...
              <div className="winner-announcement space-y-4 relative">
                ...
                <div className="text-xl text-[#C39A6B]">Press "1" and "2" together to play again</div>
                <div className="text-lg text-zinc-400">Press "1" for single player</div>
